...
\begin{itemize}
    ...
    \item \textbf{RQ2:} How well can a compression method, using tokenization be trained for a specific task-type while generalizing well within different tasks of this task-type without specific fine-tuning?
    \item \textbf{RQ3:} What effects does the use of tokenization as a transform and quantization strategy have on the rate-utility trade-off in the case of time-series data?
\end{itemize}
